...
@section('content_header')
    <h1><strong>Areas</strong> <small class="text-muted">Editar registro</small></h1>
@stop
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{route('areasUpdate', $area->id)}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="contacto" class="form-control @error('contacto') is-invalid @enderror" value="{{ old('contacto', $area->contacto) }}">
